<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-3 py-4 lg:px-4">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img class="mx-auto h-6 w-auto" src="/android-chrome-512x512.png" alt="Letras App" />
      <h2 class="mt-4 text-center text-lg font-bold tracking-tight text-white">Inicia sesión en tu cuenta</h2>
    </div>
